...
png(filename="Ex2MVPPostOmega.png", width=600, height=400)
draws <- As.mcmc.list(m2, pars=c("Omega"))
beanplot(data.frame(draws[[1]][,c(2:4, 7:8, 12)]), 
         horizontal=TRUE, las=1, what=c(0, 1, 1, 0), side="second",
         main=paste("Posterior Density of Omega", log=""))
...
png(filename="Ex2MVPTrueVEstz.png", width=600, height=400)
...
png(filename="Ex3MVPPostOmega.png", width=600, height=400)
draws <- As.mcmc.list(m3, pars=c("Omega"))
beanplot(data.frame(draws[[1]][,c(2:4, 7:8, 12)]), 
         horizontal=TRUE, las=1, what=c(0, 1, 1, 0), side="second",
         main=paste("Posterior Density of Omega", log=""))
...
png(filename="Ex3MVPTrueVEstz.png", width=600, height=400)
